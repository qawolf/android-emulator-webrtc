...
export class RtcClient {
  ...
  requestRtcStream(
    request: google_protobuf_empty_pb.Empty,
    metadata: grpcWeb.Metadata | null): Promise<rtc_service_pb.RtcId>;

  requestRtcStream(
    request: google_protobuf_empty_pb.Empty,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: rtc_service_pb.RtcId) => void): grpcWeb.ClientReadableStream<rtc_service_pb.RtcId>;

  requestRtcStream(
    request: google_protobuf_empty_pb.Empty,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: rtc_service_pb.RtcId) => void) {
  ...
  receiveJsepMessages(
    request: rtc_service_pb.RtcId,
    metadata?: grpcWeb.Metadata): grpcWeb.ClientReadableStream<rtc_service_pb.JsepMsg> {
  ...
  receiveJsepMessage(
    request: rtc_service_pb.RtcId,
    metadata: grpcWeb.Metadata | null): Promise<rtc_service_pb.JsepMsg>;

  receiveJsepMessage(
    request: rtc_service_pb.RtcId,
    metadata: grpcWeb.Metadata | null,
    callback: (err: grpcWeb.RpcError,
               response: rtc_service_pb.JsepMsg) => void): grpcWeb.ClientReadableStream<rtc_service_pb.JsepMsg>;

  receiveJsepMessage(
    request: rtc_service_pb.RtcId,
    metadata: grpcWeb.Metadata | null,
    callback?: (err: grpcWeb.RpcError,
               response: rtc_service_pb.JsepMsg) => void) {
    if (callback !== undefined) {
      return this.client_.rpcCall(
        this.hostname_ +
          '/android.emulation.control.Rtc/receiveJsepMessage',
